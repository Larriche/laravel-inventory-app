                        ...
                        <div class="row">
                            <div class="col-md-4 col-md-offset-8">
                                <div class="vendor-logo-placeholder">
                                    <img src="/images/item_image_placeholder.png" class="img img-responsive  image-placeholder" id="uploaded-logo">
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-10 col-md-10 col-sm-10 col-lg-offset-1 col-md-offset-1 col-sm-offset-1">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-md-offset-8">
                                <div class="vendor-logo-placeholder">
                                    <img src="/images/item_image_placeholder.png" class="img img-responsive  image-placeholder" id="update-uploaded-logo">
                                </div>
                            </div>
                        </div>
